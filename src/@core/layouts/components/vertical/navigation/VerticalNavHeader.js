  ...
  return (
    <MenuHeaderWrapper className='nav-header' sx={{ pl: menuHeaderPaddingLeft() }}>
      {userNavMenuBranding ? (
        ...
        <LinkStyled href='/'>
          <img alt='login-ovec' src={`/images/oveclogo.png`} width={'20%'} alignItems={'center'} />
          <HeaderTitle variant='h4' sx={{ ...menuCollapsedStyles, ...(navCollapsed && !navHover ? {} : { ml: 3.5 }) }}>
            {themeConfig.headerMenu}
          </HeaderTitle>
        </LinkStyled>
      )}
